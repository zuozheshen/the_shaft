...
- `ui/left_console_tests.gd` 使用正式 main_3d，验证唯一 BuildingTerminalInterface、旧触控入口停用、三枚实体栏目键和滚轮接线，以及新派单、转向和当前栏目共同决定的未读灯语义；滚轮不得改写业务历史。
...
7. Q/E 转向、左台三枚实体栏目键与滚轮、主台两机位、门动画及乘客进出保持可用；
...
12. 左台屏幕本体不可点击；实体件从左到右为乘客档案、对话记录、系统日志、滚轮，屏幕与天花板留有间隙，整体比例不压迫视野，滚轮不贴边。新派单只让已有栏目点亮琥珀未读灯；仅在实际朝向左台并打开对应栏目时清灯，离开后更新应重新点亮。
13. 左台与右台屏面保持同一深青底/浅色字体系；滚轮滚动时保持水平轴线，轴向刻线绕轴移动，绿色选中/悬停指示不得与琥珀未读灯混淆。
